...
import { Home, Trash2, MapPin, Check, RefreshCw, AlertTriangle, Bell } from 'lucide-react-native';
import * as Location from 'expo-location';
import { saveHomeLocation } from '../utils/db';
...
export default function SettingsView({
  ...
  // Trigger prompt for database reset
  const handleClearAllConfirm = () => {
    if (Platform.OS === 'web') {
      const confirmWeb = window.confirm('Are you sure you want to clear all data? This will delete all trip history and your home location. This action cannot be undone.');
      if (confirmWeb) {
        onClearAllData();
      }
      return;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Configure locations, notifications, and privacy options</Text>
      </View>
      ...
      <View style={styles.sectionCard}>
        <View style={styles.sectionHeader}>
          ...
          <Text style={styles.sectionTitle}>Home Location Setup</Text>
        </View>
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity 
            ...
            activeOpacity={0.7}
          >
            <RefreshCw size={14} color="#3b82f6" style={isLoadingGPS && styles.rotateIcon} />
      ...
      <View style={[styles.sectionCard, styles.dangerBorder]}>
        <View style={styles.sectionHeader}>
          ...
          <Text style={[styles.sectionTitle, { color: '#ef4444' }]}>Privacy & Data Reset</Text>
        </View>

        <Text style={styles.sectionDesc}>
          All location tracking logs and trip histories are stored strictly locally on your device.
        </Text>
